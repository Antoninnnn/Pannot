...
CUDA_VISIBLE_DEVICES=0 python pannot/eval/eval_opi/eval_opi_dataset_pannot.py \
   --input_file /scratch/user/yining_yang/TAMU/PhD/Pannot/data/opi/OPI_DATA/KM/gSymbol2Cancer/test/gene_symbol_to_cancer_test.jsonl \
   --output_file /scratch/user/yining_yang/TAMU/PhD/Pannot/results/gene_symbol_to_cancer_test.json \
