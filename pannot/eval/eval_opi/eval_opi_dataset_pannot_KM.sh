...
#SBATCH --output=logs/pannot_eval_opi_Symbol2Tissue_%j.out
#SBATCH --error=logs/pannot_eval_opi_Symbol2Tissue_%j.err
...
CUDA_VISIBLE_DEVICES=0 python pannot/eval/eval_opi/eval_opi_dataset_pannot.py \
   --input_file /scratch/user/yining_yang/TAMU/PhD/Pannot/data/opi/OPI_DATA/KM/gSymbol2Tissue/test/gene_symbol_to_tissue_test.jsonl \
   --output_file /scratch/user/yining_yang/TAMU/PhD/Pannot/results/pretrained/gene_symbol_to_tissue_test.json \
