...
#SBATCH --output=logs/pannot_eval_opi_fine_tuned%j.out
#SBATCH --error=logs/pannot_eval_opi_fine_tuned%j.err
...
CUDA_VISIBLE_DEVICES=0 python pannot/eval/eval_opi/eval_opi_dataset_pannot.py \
   --input_file /scratch/user/yining_yang/TAMU/PhD/Pannot/data/opi/OPI_DATA/SU/Subcellular_localization/test/subcell_loc_test.jsonl \
   --output_file /scratch/user/yining_yang/TAMU/PhD/Pannot/results/fine_tuned/subcell_loc_test.json \
